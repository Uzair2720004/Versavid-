    ...
    <section id="cta" ref={ref} className="relative min-h-[90vh] w-full overflow-hidden bg-black flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1] }}>
          ...
          <p className="mt-7 mx-auto max-w-xl text-[16px] leading-[1.4] text-[#a8aeb8]">Versavid writes the script, generates the visuals, adds voiceover and captions. Start free with 15 credits — no credit card required.</p>
          ...
          <p className="mt-6 text-[12px] text-[#767D88]">15 free credits · No credit card required</p>
        </motion.div>
      </div>
    </section>
  );
