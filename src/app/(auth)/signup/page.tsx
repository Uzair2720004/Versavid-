        ...
        <div className="relative z-10 flex flex-col justify-end p-12">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1], delay: 0.3 }}>
            ...
            <div className="mt-8 space-y-3">
              {['15 free credits on signup', 'AI script, visuals, voiceover & captions', 'YouTube Shorts & long-form support', 'No credit card required'].map((f) => (
            ...
            {done ? (
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center py-8">
                ...
                <p className="mt-2 text-[13px] text-[#767D88] leading-[1.5]">
                  We sent a confirmation link to <span className="text-white">{email}</span>. Click it to activate your account and get your 15 free credits.
                </p>
              ...
              <>
                ...
                <p className="mt-4 text-center text-[11px] text-[#767D88] flex items-center justify-center gap-1">
                  <Sparkles className="h-3 w-3 text-cyan-400" /> Get 15 free credits — no credit card required
                </p>
